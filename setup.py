...
setup(name='sdg',
      ...
      python_requires='>=3.5',
      install_requires=['pyyaml', 'gitpython', 'numpy', 'pandas', 'yamlmd==1.5.2', 'jsonschema', 'requests', 'humanize', 'unicode-slugify', 'sdmx1', 'frictionless', 'csvw', 'mammoth', 'pyquery', 'pyjstat', 'Jinja2'],
      dependency_links=[
